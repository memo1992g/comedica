...
import styles from './FinancialCorrespondentsStats.module.css';

interface FinancialCorrespondentsStatsProps {
  totalTransactions: number;
  totalAmount: number;
}

export default function FinancialCorrespondentsStats({ 
  totalTransactions, 
  totalAmount 
}: FinancialCorrespondentsStatsProps) {
