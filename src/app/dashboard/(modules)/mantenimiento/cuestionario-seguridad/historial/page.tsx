  ...
  const loadAuditLogs = async () => {
    try {
      const response = await getAuditLog({
        ...
        page: currentPage,
        pageSize,
        module: 'Cuestionario de Seguridad para Soporte Telefónico',
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <button className={styles.backBtn} onClick={() => router.push('/dashboard/mantenimiento/cuestionario-seguridad')} aria-label="Volver">
          <ArrowLeft size={20} />
        </button>
