...
export const postRecurringReportService = async ({
  data,
  noToken = true,
}: {
  data: BackofficeApiRequestI<RecurringReportRequestI>;
  noToken?: boolean;
}): Promise<BackofficeApiResponse<RecurringReportResponseI>> => {
  ...
  return res as BackofficeApiResponse<RecurringReportResponseI>;
};
